...
LOCAL_SQLITE_URL = "sqlite:///" + os.path.join(DB_DIR, "landlordpro.db")
...
class Config:
    ...
    # Use production DATABASE_URL if available, otherwise local SQLite
    SQLALCHEMY_DATABASE_URI = DATABASE_URL or LOCAL_SQLITE_URL
    ...
    # ---------------------------------------------------------
    # M-Pesa Daraja
    # If credentials are absent, the app uses simulation mode.
    # ---------------------------------------------------------
    ...
    MPESA_CALLBACK_URL = os.getenv(
        "MPESA_CALLBACK_URL",
        "http://127.0.0.1:5000/mpesa/callback"
    )
    ...
    # ---------------------------------------------------------
    # OpenAI assistant
    # If absent, rule-based assistant is used.
    # ---------------------------------------------------------
